...
function initProductExplorer() {
  ...
  const triggerInquiry = (categoryVal, productVal) => {
    ...
    if (quoteFormSelect) {
      const validCategories = ['switches', 'weatherproof', 'wiring_accessories', 'cable_management', 'cable_termination', 'industrial_plug_socket', 'installation_boxes', 'ventilation', 'insect_killer'];
