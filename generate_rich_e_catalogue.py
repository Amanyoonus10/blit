...
os.makedirs('/tmp/blit_e_thumbnails', exist_ok=True)

def prepare_thumb(path):
    if not os.path.exists(path):
        return None
    thumb_name = os.path.splitext(os.path.basename(path))[0] + '_thumb.jpg'
    out_path = os.path.join('/tmp/blit_e_thumbnails', thumb_name)
...
class PDF(FPDF):
    def header(self):
        ...
        self.set_xy(110, 10)
        self.cell(85, 8, 'E RANGE SPECIFICATION CATALOGUE 2026')
...
E_CATEGORIES = [
    {
        "cat_title": "1. 13A Switched Socket Outlets (BS 1363-2 Compliant)",
        "items": [
            {"code": "E405", "desc": "13A 1-Gang Single Switched Socket (Curved White Profile)", "dim": "86 x 86 mm", "std": "BS 1363-2", "img": "/Users/amanyoonus/Desktop/Blit/assets/products/e_range/E405.webp"},
            {"code": "E406", "desc": "13A 2-Gang Twin Switched Socket with Safety Shutters", "dim": "146 x 86 mm", "std": "BS 1363-2", "img": "/Users/amanyoonus/Desktop/Blit/assets/products/e_range/E406.webp"}
        ]
    }
]
...
pdf.set_xy(20, 28)
pdf.cell(170, 8, 'E RANGE CONTEMPORARY SWITCHES & SOCKETS')
pdf.set_font('Helvetica', '', 9.5)
pdf.set_text_color(71, 85, 105)
pdf.set_xy(20, 36)
pdf.cell(170, 6, 'Complete Technical Specifications for Curved White Polycarbonate Wiring Accessories')
pdf.set_y(54)
...
out_pdf = '/Users/amanyoonus/Desktop/Blit/assets/catalogues/BLIT_E_Range_Catalogue_2026.pdf'
pdf.output(out_pdf)

public_pdf = '/Users/amanyoonus/Desktop/Blit/public/assets/catalogues/BLIT_E_Range_Catalogue_2026.pdf'
...
print(f"E Range PDF catalogue successfully generated: {size_mb:.2f} MB")
