...
os.makedirs('/tmp/blit_ip66_thumbnails', exist_ok=True)

def prepare_thumb(path):
    if not os.path.exists(path):
        return None
    thumb_name = os.path.splitext(os.path.basename(path))[0] + '_thumb.jpg'
    out_path = os.path.join('/tmp/blit_ip66_thumbnails', thumb_name)
...
class PDF(FPDF):
    def header(self):
        ...
        self.set_xy(100, 10)
        self.cell(95, 8, 'IP66 WEATHERPROOF SPECIFICATION CATALOGUE 2026')
...
IP66_CATEGORIES = [
    {
        "cat_title": "1. IP66 Weatherproof Switches (20AX High Inrush Capacity)",
        "items": [
            {"code": "BTAG3012WHI", "desc": "1 Gang 2 Way Weatherproof Switch (20AX)", "dim": "86 x 86 mm", "std": "BS EN 60669-1 / IP66", "img": "/Users/amanyoonus/Desktop/Blit/assets/products/weatherproof/BTAG3012WHI.webp"},
            {"code": "BTAG3022WHI", "desc": "2 Gang 2 Way Weatherproof Switch (20AX)", "dim": "86 x 86 mm", "std": "BS EN 60669-1 / IP66", "img": "/Users/amanyoonus/Desktop/Blit/assets/products/weatherproof/BTAG3022WHI.webp"},
            {"code": "BTAG3013WHI", "desc": "1 Gang Intermediate Weatherproof Switch (20AX)", "dim": "86 x 86 mm", "std": "BS EN 60669-1 / IP66", "img": "/Users/amanyoonus/Desktop/Blit/assets/products/weatherproof/BTAG3013WHI.webp"},
...
pdf.set_xy(20, 28)
pdf.cell(170, 8, 'IP66 WEATHERPROOF WIRING ACCESSORIES')
pdf.set_font('Helvetica', '', 9.5)
pdf.set_text_color(71, 85, 105)
pdf.set_xy(20, 36)
pdf.cell(170, 6, 'Dust-Tight & High Pressure Water Jet Protected Outdoor Switches & Protective Enclosures')
pdf.set_y(54)

for cat in IP66_CATEGORIES:
    if pdf.get_y() > 220:
        pdf.add_page()
    ...
    for item in cat["items"]:
        ...
        pdf.set_text_color(15, 23, 42)
        pdf.cell(34, 6, item["code"])
        
        # Description
        pdf.set_xy(73, row_y + 4)
        pdf.set_font('Helvetica', '', 8.5)
        pdf.set_text_color(71, 85, 105)
        pdf.multi_cell(60, 4.5, item["desc"])
...
out_pdf = '/Users/amanyoonus/Desktop/Blit/assets/catalogues/BLIT_IP66_Range_Catalogue_2026.pdf'
pdf.output(out_pdf)

public_pdf = '/Users/amanyoonus/Desktop/Blit/public/assets/catalogues/BLIT_IP66_Range_Catalogue_2026.pdf'
shutil.copyfile(out_pdf, public_pdf)

print(f"IP66 PDF catalogue generated successfully: {out_pdf}")
